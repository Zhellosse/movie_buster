...
class MovieFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $movie2->setCountry('US');
        $movie2->setUser($this->getReference('userr')); 
        $movie2->addActors($this->getReference('actor'));
        $movie2->addGenre($this->getReference('genre2'));
        $manager->persist($movie2);
        ...
        $movie3->setAffiche('public\asset\img\movieaffiche\grantorino_.jpg');
        ...
        $movie4->setAffiche('public\asset\img\movieaffiche\vpourvendetta_.jpg');
        $movie4->setTrailer('https://www.youtube.com/watch?v=bS2ca-vWLSg');
        ...
        $movie5->setAffiche('public\asset\img\movieaffiche\tdn_.jpg');
        $movie5->setTrailer('https://www.youtube.com/watch?v=EXeTwQWrcwY');
        ...
        $movie6->setAffiche('public\asset\img\movieaffiche\tokyodrift_.jpg');
        $movie6->setTrailer('https://www.youtube.com/watch?v=p8HQ2JLlc4E');
        ...
        $movie7->setAffiche('public\asset\img\movieaffiche\sherlock_.jpg');
        $movie7->setTrailer('https://www.youtube.com/watch?v=J7nJksXDBWc');
        ...
        $movie8->setAffiche('public\asset\img\movieaffiche\robinhood_.jpg');
        $movie8->setTrailer('https://www.youtube.com/watch?v=LLjGFECRkFg');
        ...
        $movie9->setAffiche('public\asset\img\movieaffiche\leroilion_.jpg');
        $movie9->setTrailer('https://www.youtube.com/watch?v=_ujGv5dhGfk');
        ...
        $movie10->setAffiche('public\asset\img\movieaffiche\ratrace_.jpg');
        $movie10->setTrailer('https://www.youtube.com/watch?v=9bRUdtiXxKM');
        ...
        $movie11->setAffiche('public\asset\img\movieaffiche\forrestgump_.jpg');
        $movie11->setTrailer('https://www.youtube.com/watch?v=bLvqoHBptjg');
        ...
        $movie12->setAffiche('public\asset\img\movieaffiche\fightclub_.jpg');
        $movie12->setTrailer('https://www.youtube.com/watch?v=SUXWAEX2jlg');
        ...
        $movie13->setAffiche('public\asset\img\movieaffiche\ocean11_.jpg');
        $movie13->setTrailer('https://www.youtube.com/watch?v=imm6OR605UI');
        ...
        $movie14->setAffiche('public\asset\img\movieaffiche\leparrain_.jpg');
        $movie14->setTrailer('https://www.youtube.com/watch?v=sY1S34973zA');
        ...
        $movie15->setAffiche('public\asset\img\movieaffiche\vol_.jpg');
        $movie15->setTrailer('https://www.youtube.com/watch?v=bmDPW_bKpcU');
        ...
        $movie16->setAffiche('public\asset\img\movieaffiche\taxidriver_.jpg');
        $movie16->setTrailer('https://www.youtube.com/watch?v=sLpMx8_TYOo');
        ...
        $movie17->setAffiche('public\asset\img\movieaffiche\babe_.jpg');
        $movie17->setTrailer('https://www.youtube.com/watch?v=Cd1xKIU4PI4');
        ...
        $movie18->setAffiche('public\asset\img\movieaffiche\ldadob_.jpg');
        $movie18->setTrailer('https://www.youtube.com/watch?v=xcxsTkuVMQE');
        ...
        $movie19->setAffiche('public\asset\img\movieaffiche\grinch_.jpg');
        $movie19->setTrailer('https://www.youtube.com/watch?v=DD0m9t4WHEQ');
        ...
        $movie20->setAffiche('public\asset\img\movieaffiche\troie_.jpg');
        $movie20->setTrailer('https://www.youtube.com/watch?v=znTLzRJimeY');
